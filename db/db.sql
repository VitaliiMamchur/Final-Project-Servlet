...
INSERT INTO `final_project_servlet`.`statuses` (`id`, `statuses`) VALUES ('0', 'CURRENT_REQUEST');
INSERT INTO `final_project_servlet`.`statuses` (`id`, `statuses`) VALUES ('1', 'ACCEPTED_REQUEST');
INSERT INTO `final_project_servlet`.`statuses` (`id`, `statuses`) VALUES ('2', 'CLOSED_REQUEST');
INSERT INTO `final_project_servlet`.`statuses` (`id`, `statuses`) VALUES ('3', 'DECLINED_REQUEST');
