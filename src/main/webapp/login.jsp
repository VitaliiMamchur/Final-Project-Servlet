    ...
    <div class="card bg-light">
        <article class="card-body mx-auto" style="max-width: 400px;">
            ...
            <form class="form-signin" action="${pageContext.request.contextPath}/login" method="post">
                ...
                <p class="text-center"><fmt:message key="login.link.to.registration"/><a href="${pageContext.request.contextPath}/registration"><u><fmt:message key="login.button.registration"/></u></a></p>
            </form>
        </article>
    </div>
</div>
